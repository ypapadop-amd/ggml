...
struct ggml_hsa_type_traits<GGML_TYPE_F16> {
    static constexpr ggml_type ggml_type_v = GGML_TYPE_F16;
...
struct ggml_hsa_type_traits<GGML_TYPE_I8> {
    static constexpr ggml_type ggml_type_v = GGML_TYPE_I8;
...
struct ggml_hsa_type_traits<GGML_TYPE_I16> {
    static constexpr ggml_type ggml_type_v = GGML_TYPE_I16;
...
struct ggml_hsa_type_traits<GGML_TYPE_I32> {
    static constexpr ggml_type ggml_type_v = GGML_TYPE_I32;
