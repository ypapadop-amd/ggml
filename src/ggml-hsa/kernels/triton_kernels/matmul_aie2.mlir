...
// Parameters: l1_m=64, l1_n=64, l2_k=64, pack=[4,4,8], accum=f32, contract_in=None
//
...
module attributes {transform.with_named_sequence} {
  transform.named_sequence @__transform_main(%arg1: !transform.any_op {transform.readonly}) {
    ...
    // Pack [4, 4, 8], transpose A/B/C, promote C pack to L1.
    //==========================================================================

        %matmul_to_pack = transform.structured.match ops{["linalg.matmul"]} in %arg1 : (!transform.any_op) -> !transform.any_op
        %packed = transform.structured.pack %matmul_to_pack packed_sizes = [4, 4, 8]
    ...
    // Tile [16, 16, 0] for herd distribution.
    //==========================================================================
