...
////////////////////////////////////////////////////////////////////////////////
// Transform Script for Vector Addition (AIE2), f32 inputs.
// Simple elementwise add: out = a + b
// Same strategy as vecadd_aie2.mlir but pads with an f32 zero instead of a bf16
...
// (aievec.add on vector<16xf32>), so the add stays in native f32 and the
