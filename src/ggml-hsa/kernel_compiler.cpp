...
static auto ggml_backend_hsa_kernel_jit_info = []() {
    ...
    kernels[GGML_OP_ADD] = {"ggml_op_add", "binbcast.py"};
    kernels[GGML_OP_SUB] = {"ggml_op_sub", "binbcast.py"};
    kernels[GGML_OP_MUL] = {"ggml_op_mul", "binbcast.py"};
    kernels[GGML_OP_DIV] = {"ggml_op_div", "binbcast.py"};
