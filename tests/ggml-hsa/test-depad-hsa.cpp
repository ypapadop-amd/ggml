...
// Standalone test for the internal HSA_DEPAD kernel: f32 [d0pad, d1pad] -> f32 [d0, d1], gathering
// the top-left [d0, d1] sub-block out of a padded buffer. Exercises the real build+dispatch path
// via the internal test hook.
