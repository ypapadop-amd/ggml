...
def test_padding_matches_the_host_rule():
    """The presim padding must equal what ggml_hsa_prepare_mul_mat_f32 does."""
    assert padded_dims(500, 500, 784) == (512, 512, 784)
    assert padded_dims(10, 500, 500) == (32, 512, 504)
    assert padded_dims(512, 512, 512) == (512, 512, 512)
